"""
Farm Agent Main Application
===========================

Main entry point for the Farm Agent service that consumes from RabbitMQ
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('farm_agent.log'),
...
class FarmAgentService:
    """
    Main service orchestrator for the Farm Agent
    """
    ...
    async def start(self):
        ...
        try:
            logger.info("=" * 70)
            logger.info("Starting Farm Agent Service")
            logger.info("=" * 70)
            ...
            logger.info("=" * 70)
            logger.info("Farm Agent Service is running!")
            logger.info("Listening for payment collection requests...")
    ...
    async def shutdown(self):
        ...
        logger.info("\n" + "=" * 70)
        logger.info("Shutting down Farm Agent Service...")
        logger.info("=" * 70)
        ...
        logger.info("Farm Agent Service stopped")
        logger.info("=" * 70)
